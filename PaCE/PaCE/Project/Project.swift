...
struct Project: Codable, Identifiable, Hashable {
    ...
    var eORName: Contact = Contact()
    var eORNameID: String = ""
    var detailerName: Contact = Contact()
    var detailerNameID: String = ""
    var inspectionLab: Contact = Contact()
    var inspectionLabID: String = ""
    var steelErectorName: Contact = Contact()
    var steelErectorNameID: String = ""
    var steelFabricatorName: Contact = Contact()
    var steelFabricatorNameID: String = ""
    var generalContractor: Contact = Contact()
    var generalContractorID: String = ""
    var primaryContactName: Contact = Contact()
    var primaryContactNameID: String = ""
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case eORNameID = "eORNameID"
        case detailerNameID = "detailerNameID"
        case inspectionLabID = "inspectionLabID"
        case steelErectorNameID = "steelErectorNameID"
        case steelFabricatorNameID = "steelFabricatorNameID"
        case generalContractorID = "generalContractorID"
        case primaryContactNameID = "primaryContactNameID"
